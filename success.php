...
<div class="container" style="margin-left: 35%;  margin-right: 30%;">
    <div class="row">
        <div class="col-sm-6 col-md-4">
            <h5>Thank for ordering from FOOD STORE. The ordered shall be delivered to you shortly.</h5>
        </div>
    </div>
    <h5>Order some more tasty food items <a href="/foodstore/home.php">here.</a> </h5>
